...
namespace CleanWpfApp
{
    ...
    public sealed class PackWebRequestFactory : IWebRequestCreate
    {
        ...
        WebRequest IWebRequestCreate.Create(Uri uri)
        {
            ...
            {
                throw new ArgumentException(Strings.UriMustBeAbsolute, nameof(uri));
            }
            ...
            {
                throw new ArgumentException(SR.Format(Strings.UriSchemeMismatch, PackUriHelper.UriSchemePack), nameof(uri));
            }
            ...
            var packageUri = PackUriHelper.GetPackageUri(uri);
            ...
            if (partUri != null)
            {
                ...
                var c = PreloadedPackages.GetPackage(packageUri, out var cachedPackageIsThreadSafe);
