...
namespace CleanWpfApp
{
    ...
    public class ResourceDictionary : IDictionary, ISupportInitialize, IUriContext, INameScope
    {
        #region Constructor
        ...
        public Uri Source
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(SR.Format(Strings.ResourceDictionaryLoadFromFailure, value == null ? "''" : value.ToString()));
                }
                ...
                if (loadedRD == null)
                {
                    throw new InvalidOperationException(SR.Format(Strings.ResourceDictionaryLoadFromFailure, _source.ToString()));
                }
        ...
        {
            throw new NotSupportedException(Strings.NamesNotSupportedInsideResourceDictionary);
        }
        ...
        private void SetDeferrableContent(DeferrableContent deferrableContent)
        {
            ...
            if (_source == null)
            {
                ...
                {
                    throw new InvalidOperationException(Strings.ResourceDictionaryDuplicateDeferredContent);
                }
            }
            else if (keys.Count > 0)
            {
                throw new InvalidOperationException(Strings.ResourceDictionaryDeferredContentFailure);
            }
        }
