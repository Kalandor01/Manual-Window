...
namespace CleanWpfApp
{
    ...
    internal class NativeMethods
    {
        ...
        public static IntPtr InvalidIntPtr = -1;
        public static IntPtr LPSTR_TEXTCALLBACK = -1;
        ...
        */
        ...
        public sealed class VARIANT
        {
            ...
            public void Clear()
            {
                if ((vt == (int)tagVT.VT_UNKNOWN || vt == (int)tagVT.VT_DISPATCH) && data1.Value != IntPtr.Zero)
                {
                    Marshal.Release(data1.Value);
                }

                if (vt == (int)tagVT.VT_BSTR && data1.Value != IntPtr.Zero)
                {
                    SysFreeString(data1.Value);
                }

                data1.Value = data2.Value = IntPtr.Zero;
            ...
            public object ToObject()
            {
                ...
                int vtType = vt & (short)tagVT.VT_TYPEMASK;
        ...
        [DllImport("gdi32.dll")]
        public static unsafe extern int ExtEscape(HDC hdc, int nEscape, int cbInput, PrinterEscape* lpvInData, int cbOutput, [Out] void* lpvOutData);
        ...
        {// (*)indicates must be specfied
            internal int cbSize;                     // (*)size of this structure (20)
            ...
            internal int fwType;                     // Flags about print job (0)
        }
        ...
        [DllImport("gdi32.dll")]
        public unsafe static extern int StartDoc(HDC hdc, ref DocInfo docInfo);
