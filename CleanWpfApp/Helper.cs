...
namespace CleanWpfApp
{
    ...
    internal static class Helper
    {
        ...
        private class FindResourceHelper
        {
            ...
            {
                throw new ResourceReferenceKeyNotFoundException(SR.Format(Strings.MarkupExtensionResourceNotFound, _name), _name);
            }
        ...
        */
                                    ...
                                    bool throwIfNeither)
        {
            ...
            {
                throw new InvalidOperationException(SR.Format(Strings.MustBeFrameworkDerived, d.GetType()));
            }
            else
            {
                fe = null;
            ...
            if (targetProperty != null)
            {
                ...
                else
                {
                    ...
                    if (targetMember != null)
                    {
                        ...
                        {
                            throw new XamlParseException(SR.Format(Strings.MarkupExtensionDynamicOrBindingOnClrProp,
                    ...
                    else
                    {
                        ...
                        {
                            throw new XamlParseException(SR.Format(Strings.MarkupExtensionDynamicOrBindingInCollection,
                                                                markupExtension.GetType().Name,
        ...
        internal static object ReadItemValue(DependencyObject owner, object item, int dpIndex)
        {
            if (item != null)
            {
                var itemValues = GetItemValues(owner, item);
        ...
        internal static void StoreItemValue(DependencyObject owner, object item, int dpIndex, object value)
        {
            if (item != null)
            {
                var itemValues = EnsureItemValues(owner, item);
                ...
                bool found = false;
                var keyValue = new KeyValuePair<int, object>(dpIndex, value);
        ...
        internal static List<KeyValuePair<int, object>> GetItemValues(
        ...
        internal static List<KeyValuePair<int, object>> EnsureItemValues(DependencyObject owner, object item)
        {
            ...
            var itemValues = GetItemValues(owner, item, itemValueStorage);
        ...
        internal static void SetItemValuesOnContainer(DependencyObject owner, DependencyObject container, object item)
        {
            ...
            var itemValues = GetItemValues(owner, item) ?? new List<KeyValuePair<int, object>>();
        ...
        private static void ClearItemValueStorageRecursive(WeakDictionary<object, List<KeyValuePair<int, object>>> itemValueStorage, int[] dpIndices)
        {
            if (itemValueStorage != null)
            {
                foreach (List<KeyValuePair<int, object>> itemValuesList in itemValueStorage.Values)
                {
                    ...
                    {
                        var itemValue = itemValuesList[i];
