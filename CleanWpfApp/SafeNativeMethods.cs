...
namespace CleanWpfApp
{
    ...
    internal static class SafeNativeMethods
    {
        ...
        public static bool GetStringTypeEx(
            uint locale,
            uint infoType,
            char[] sourceString,
            int count,
        ...
        public static int? GetCurrentSessionId()
        {
            ...
            if (SafeNativeMethodsPrivate.ProcessIdToSessionId(
                GetCurrentProcessId(), out var sessionId))
            {
                result = sessionId;
            }
        ...
        public static bool IsCurrentSessionConnectStateWTSActive(int? SessionId = null, bool defaultResult = true)
        {
            ...
            try
            {
                if (SafeNativeMethodsPrivate.WTSQuerySessionInformation(
                    ...
                    out buffer, out var bytesReturned) && (bytesReturned >= sizeof(int)))
                {
        ...
        private static class SafeNativeMethodsPrivate
        {
            ...
            [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] ushort[] charTypes);
