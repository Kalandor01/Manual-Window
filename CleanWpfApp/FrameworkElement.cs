...
namespace CleanWpfApp
{
    ...
    public class FrameworkElement : UIElement, IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient
    {
        ...
        internal static FrameworkElement FindNamedFrameworkElement(FrameworkElement startElement, string targetName)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(SR.Format(Strings.TargetNameNotFound, targetName));
                }

                var fo = new FrameworkObject(targetObject);
                if (fo.IsFE)
                {
                    targetFE = fo.FE;
                }
                ...
                {
                    throw new InvalidOperationException(SR.Format(Strings.NamedObjectMustBeFrameworkElement, targetName));
                }
            }
        ...
        public TriggerCollection Triggers
        {
            get
            {
                var triggerCollection = EventTrigger.TriggerCollectionField.GetValue(this);
        ...
        internal static object FindImplicitStyleResource(FrameworkContentElement fce, object resourceKey, out object source)
        {
            ...
            if (fce.ShouldLookupImplicitStyles)
            {
                ...
                var implicitStyle = FindResourceInternal(null, fce, FrameworkContentElement.StyleProperty, resourceKey, unlinkedParent, allowDeferredResourceReference, mustReturnDeferredResourceReference, boundaryElement, isImplicitStyleLookup, out source);
        ...
        protected sealed override Size MeasureCore(Size availableSize)
        {
            ...
            else
            {
                ...
                var ltd = LayoutTransformDataField.GetValue(this);
                {
                    var layoutTransform = this.LayoutTransform;
                ...
                if (ltd != null)
                {
                    ...
                    var unclippedBoundsTransformed = Rect.Transform(new Rect(0, 0, unclippedDesiredSize.Width, unclippedDesiredSize.Height), ltd.Transform.Value);
                ...
                if (ltd != null)
                {
                    var childBoundsTransformed = Rect.Transform(new Rect(0, 0, desiredSize.Width, desiredSize.Height), ltd.Transform.Value);
                ...
                var sb = UnclippedDesiredSizeField.GetValue(this);
                if (clipped
        ...
        protected sealed override void ArrangeCore(Rect finalRect)
        {
            ...
            var dpi = GetDpi();
            var ltd = LayoutTransformDataField.GetValue(this);
            var transformedUnroundedDS = Size.Empty;
            ...
            if (BypassLayoutPolicies)
            {
                ...
                var inkSize = ArrangeOverride(finalRect.Size);
                RenderSize = inkSize;
            ...
            else
            {
                ...
                if (ltd != null)
                {
                    ...
                    var potentialArrangeSize = FindMaximalAreaLocalSpaceRect(ltd.Transform, arrangeSize);
                ...
                var effectiveMaxHeight = Math.Max(unclippedDesiredSize.Height, mm.maxHeight);
                ...
                if (ltd != null)
                {
                    var inkRectTransformed = Rect.Transform(new Rect(0, 0, clippedInkSize.Width, clippedInkSize.Height), ltd.Transform.Value);
        ...
        {
            var localArgs = new SizeChangedEventArgs(this, sizeInfo)
            {
        ...
        protected override Geometry GetLayoutClip(Size layoutSlotSize)
        {
            ...
            if (NeedsClipBounds || ClipToBounds)
            {
                ...
                var maxWidthClip = double.IsPositiveInfinity(mm.maxWidth) ? inkSize.Width : mm.maxWidth;
                var maxHeightClip = double.IsPositiveInfinity(mm.maxHeight) ? inkSize.Height : mm.maxHeight;

                //need to clip because the computed sizes exceed MaxWidth/MaxHeight/Width/Height
                var needToClipLocally =
                ...
                var rtlMirror = GetFlowDirectionTransform();
                ...
                if (needToClipSlot)
                {
                    var offset = ComputeAlignmentOffset(clippingSize, inkSize);
                    ...
                    if (ltd != null)
                    {
                        ...
                        {
                            var localClipRect = new Rect(0, 0, maxWidthClip, maxHeightClip);
                            ...
                            var localClip = new RectangleGeometry(localClipRect);
                    ...
                    else //no layout transform, intersect axis-aligned rects
                    {
                        ...
                        {
                            var localRect = new Rect(0, 0, maxWidthClip, maxHeightClip);
        ...
        internal static void InternalSetLayoutTransform(UIElement element, Transform layoutTransform)
        {
            ...
            var additionalTransform = element is not FrameworkElement fe ? null : fe.GetFlowDirectionTransform(); //rtl
            ...
            var ts = new TransformCollection
            {
        ...
        private void SetLayoutOffset(Vector offset, Size oldRenderSize)
        {
            ...
            {
                var additionalTransform = GetFlowDirectionTransform(); //rtl
                    ...
                    || ltd != null)
                {
                    ...
                    if (ltd != null)
                    {
                        ...
                        var inkRectTransformed = Rect.Transform(new Rect(inkSize), ltd.Transform.Value);
                    ...
                    if (renderTransform != null)
                    {
                        var origin = GetRenderTransformOrigin();
        ...
        {
            var relativeOrigin = RenderTransformOrigin;
        ...
        /// </summary>
        internal static readonly EventPrivateKey InitializedKey = new();
        ...
        public bool IsLoaded
        {
            get
            {
                var loadedPending = LoadedPending;
                var unloadedPending = UnloadedPending;
            ...
            DependencyObject modelTreeNode)
        {
            while (modelTreeNode != null && modelTreeNode != mergePoint)
            {
                ...
                else if (modelTreeNode is ContentElement contentElement)
                {
                ...
                else if (modelTreeNode is UIElement3D uiElement3D)
                {
        ...
        public void RegisterName(string name, object scopedElement)
        {
            ...
            {
                throw new InvalidOperationException(SR.Format(Strings.NameScopeNotFound, name, "register"));
            }
        }
        ...
        public void UnregisterName(string name)
        {
            ...
            {
                throw new InvalidOperationException(SR.Format(Strings.NameScopeNotFound, name, "unregister"));
            }
        }
        ...
        {
            return FindName(name, out var scopeOwner);
        }
        ...
        {
            var nameScope = FindScope(this, out scopeOwner);
            if (nameScope != null)
            {
        ...
        internal object FindResourceOnSelf(object resourceKey, bool allowDeferredResourceReference, bool mustReturnDeferredResourceReference)
        {
            ...
            {
                return resources.FetchResource(resourceKey, allowDeferredResourceReference, mustReturnDeferredResourceReference, out var canCache);
            }
        ...
        protected internal void AddLogicalChild(object child)
        {
            if (child != null)
            {
                ...
                try
                {
                    ...
                    var fo = new FrameworkObject(child as DependencyObject);
        ...
        internal void OnAncestorChangedInternal(TreeChangeInfo parentTreeState)
        {
            ...
            {
                var fo = new FrameworkObject(this, null);
        ...
        internal FrugalObjectList<DependencyProperty> InvalidateTreeDependentProperties(TreeChangeInfo parentTreeState, bool isSelfInheritanceParent, bool wasSelfInheritanceParent)
        {
            ...
            try
            {
                ...
                var selfStyle = Style;
                var selfThemeStyle = ThemeStyle;
                var templatedParent = TemplatedParent;
                var childIndex = TemplateChildIndex;
                ...
                var hasStyleChanged = HasStyleChanged;

                // Fetch selfStyle, hasStyleChanged and childIndex for the current node
                GetTemplatedParentChildRecord(templatedParent, childIndex, out childRecord, out var isChildRecordValid);

                var hasParent = GetFrameworkParent(this, out var parentFE, out var parentFCE);
        ...
        internal bool HasFefLoadedChangeHandler
        {
            get
            {
                ...
                var fefRoot = BroadcastEventHelper.GetFEFTreeRoot(TemplatedParent);
                if (null == fefRoot)
                {
                    return false;
                }
                var fef = StyleHelper.FindFEF(fefRoot, TemplateChildIndex);
                if (null == fef)
                {
                    return false;
                }
        ...
        internal void UpdateStyleProperty()
        {
            if (!HasStyleInvalidated)
            {
                ...
                {
                    throw new InvalidOperationException(SR.Format(Strings.CyclicStyleReferenceDetected, this));
                }
            }
        }
        ...
        internal void UpdateThemeStyleProperty()
        {
                ...
                try
                {
                    ...
                    if (
                        GetValueEntry(
                                    ...
                                    ).Value is ContextMenu contextMenu
                    )
                    {
                    ...
                    if (
                        GetValueEntry(
                                    ...
                                    null,
                                    RequestFlags.DeferredReferences
                                ).Value is DependencyObject toolTip
                    )
                    {
            ...
            {
                throw new InvalidOperationException(SR.Format(Strings.CyclicThemeStyleReferenceDetected, this));
            }
        }
        ...
        internal void FireLoadedOnDescendentsInternal()
        {
            ...
            {
                var parent = Parent ?? VisualTreeHelper.GetParent(this);
        ...
        {
            var oldMentor = MentorField.GetValue(this);
            var newMentor = Helper.FindMentor(InheritanceContext);
        ...
        {
            var foMentor = new FrameworkObject((DependencyObject)sender);
        ...
        internal void RaiseInheritedPropertyChangedEvent(ref InheritablePropertyChangeInfo info)
        {
            ...
            if (store != null)
            {
                Delegate handler = store.Get(InheritedPropertyChangedKey);
                if (handler != null)
                {
        ...
        internal event EventHandler ResourcesChanged
        {
            ...
            remove { EventHandlersStoreRemove(ResourcesChangedKey, value); }
        }
        ...
        internal event InheritedPropertyChangedEventHandler InheritedPropertyChanged
        {
            ...
            remove { EventHandlersStoreRemove(InheritedPropertyChangedKey, value); }
        }
        #endregion
