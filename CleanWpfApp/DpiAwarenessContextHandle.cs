...
namespace CleanWpfApp
{
    ...
    /// </remarks>
    internal class DpiAwarenessContextHandle : SafeHandle, IEquatable<IntPtr>, IEquatable<DpiAwarenessContextHandle>, IEquatable<DpiAwarenessContextValue>
    {
        ...
        {
            if (obj is IntPtr objPtr)
            {
                return Equals(objPtr);
            }
            else if (obj is DpiAwarenessContextHandle objHandle)
            {
                return Equals(objHandle);
            }
            else if (obj is DpiAwarenessContextValue objValue)
            {
