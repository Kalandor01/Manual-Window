...
namespace CleanWpfApp
{
    internal static class IconHelper
    {
        ...
        public static void GetDefaultIconHandles(out NativeMethods.IconHandle largeIconHandle, out NativeMethods.IconHandle smallIconHandle)
        {
            ...
            var extractedCount = UnsafeNativeMethods.ExtractIconEx(iconModuleFile, 0, out largeIconHandle, out smallIconHandle, 1);
        }
        ...
        )
        {
            ...
            try
            {
                ...
                colorBitmap = UnsafeNativeMethods.CreateDIBSection(
