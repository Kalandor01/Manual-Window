...
namespace CleanWpfApp
{
    ...
    internal abstract class TraceProvider
    {
        ...
        protected EventTrace.Keyword _keywords = 0; /* aka Flags */
        protected EventTrace.Keyword _matchAllKeyword = 0; /*Vista only*/
        ...
        --*/
        {
            ...
            {
                dataDescriptor->Size = sizeof(long);
            ...
            {
                dataDescriptor->Size = sizeof(uint);
                uint* uintptr = (uint*)dataBuffer;
                *uintptr = uintData;
                dataDescriptor->Ptr = (ulong)uintptr;
            }
            else if (data is ulong ulongData)
            {
                dataDescriptor->Size = sizeof(ulong);
            ...
            {
                dataDescriptor->Size = sizeof(char);
            ...
            {
                dataDescriptor->Size = sizeof(byte);
            ...
            {
                dataDescriptor->Size = sizeof(short);
            ...
            {
                dataDescriptor->Size = sizeof(sbyte);
            ...
            {
                dataDescriptor->Size = sizeof(double);
            ...
            {
                dataDescriptor->Size = sizeof(bool);
                bool* boolptr = (bool*)dataBuffer;
                *boolptr = boolData;
                dataDescriptor->Ptr = (ulong)boolptr;
            }
            else if (data is Guid guidData)
            {
            ...
            {
                dataDescriptor->Size = sizeof(decimal);
                decimal* decimalptr = (decimal*)dataBuffer;
                *decimalptr = decimalData;
    ...
    internal sealed class ClassicTraceProvider : TraceProvider
    {
        ...
        internal override unsafe void Register(Guid providerGuid)
        {
            ...
            var dummyGuid = new Guid(0xb4955bf0,
                                      0x3af1,
                                      0x4740,
                                      0xb4, 0x75,
            ...
            ClassicEtw.RegisterTraceGuidsW(_etwProc, IntPtr.Zero, ref providerGuid, 1, ref guidReg, null, null, out var registrationHandle);
