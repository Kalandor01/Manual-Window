...
namespace CleanWpfApp
{
    ...
    {
        /// <summary>
        /// Convert relative path to the right format which is used as ResourceID.
        ...
        /// <summary>
        /// This is the central place that returns right ResourceID for the passed SourceUri.
        /// </summary>
        ...
        static private string GetResourceIDFromUri(Uri baseUri, Uri sourceUri)
        {
            ...
            //
            // If the sourceUri is not relative to baseUri, Emtpy string is returned as resource id.
            ...
            if (baseUri.Scheme == sourceUri.Scheme && baseUri.Host == sourceUri.Host)
            {
                ...
                {
                    resourceID = sourcePath[basePath.Length..];
                }
            }
