...
namespace CleanWpfApp
{
    ...
    static class WpfWebRequestHelper
    {
        ...
        internal static string DefaultUserAgent
        {
            get
            {
                _defaultUserAgent ??= UnsafeNativeMethods.ObtainUserAgentString();
        ...
        internal static WebResponse GetResponse(WebRequest request)
        {
            ...
            if (response is HttpWebResponse && request is not HttpWebRequest)
            {
            ...
            if (response == null)
            {
                ...
                throw new IOException(SR.Format(Strings.GetResponseFailed, requestUri.ToString()));
            }
        ...
        internal static ContentType GetContentType(WebResponse response)
        {
            ...
            if (response is not FileWebResponse)
            {
