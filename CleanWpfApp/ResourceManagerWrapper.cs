        ...
        internal Stream GetStream(string name)
        {
            ...
            if (stream == null)
            {
                ...
                if (ResourceSet != null)
                {
                    ...
                    {
                        if (e is not MissingManifestResourceException)
                        {
                            throw;
                        }
            ...
            get
            {
                if (_resourceList == null)
                {
                    ...
                    if (ResourceManager != null)
                    {
                        ...
                        //
                        ResourceSet rsLoc = ResourceManager.GetResourceSet(ciNeutral, true, false);
        ...
        private ResourceSet ResourceSet
        {
            get
            {
                if (_resourceSet == null)
                {
                    ...
                    var manager = new ResourceManager(manifestResourceName, _assembly);
